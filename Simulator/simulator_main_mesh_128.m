...
TileDimension = [16 8]; % tile dimension in a mesh
global TileSize;
TileSize=[20 20];
global XDim; % 1
XDim = 1;
...
Connectivity( :, :,1) = xlsread('128coreconnectivity.xls');
...
LinkData(:,:,1) = xlsread('128_core_Link_Distance.xls');
...
for i = MaxSwitchNumber+1:SwitchTotal
...
Connectivity( :, :,1) = xlsread('128_core_wired.xls');
Connectivity( :, :,2) = xlsread('128_core_Link_Distance.xls');
Connectivity( :, :,3) = Connectivity( :, :,2)';
...
LinkCycleMatrix=xlsread('128_core_Link_Distance.xls');
