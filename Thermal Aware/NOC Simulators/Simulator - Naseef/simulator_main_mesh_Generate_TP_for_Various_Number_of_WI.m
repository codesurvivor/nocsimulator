...
clear all;
Results=[];
path(path,'Generated Connectivity Matrix xls');
% Global Simulation numbers

    global NoWirelessTranscievers ;
    NoWirelessTranscievers = 15;
    global NumberWirelessNodes;
    NumberWirelessNodes = 15;
    ...
    filename=strcat('WiNoCTest_',num2str(NumberWirelessNodes),'WI.xls');
    Connectivity( :, :,1) = xlsread(filename);
...
%     plot(1:NumberOfSimulationCycles,ThroughputPerCycle(1:NumberOfSimulationCycles,2))
    ...
    Results=[Results
        NumberWirelessNodes avghop Input Throughput Latency]
%     avghop
%     Input
%     Throughput
