...
MaxNumberOfVC = 64; %Default 8
global CoreBufferDepth;
CoreBufferDepth = 64; %Default 16
...
OutputBufferDepth = 64;
global MaxVCNumberOutput;
MaxVCNumberOutput = 64;
global MaxOutputVCNumber;
MaxOutputVCNumber = 64;
...
TileDimension = [16 16]; % tile dimension in a mesh default [8 8]
global TileSize;
TileSize=[20 20];
global XDim; % 1
XDim = 1;
...
LinkData(:,:,1) = xlsread('256_core_Link_Distance.xls');
...
Connectivity( :, :,1) = xlsread('256_core_wired.xls');
Connectivity( :, :,2) = xlsread('256_core_Link_Distance.xls');
Connectivity( :, :,3) = Connectivity( :, :,2)';
...
LinkCycleMatrix=xlsread('256_core_Link_Distance.xls');
