...
TileDimension = [16 16]; % tile dimension in a mesh
global TileSize;
TileSize=[20 20];
global XDim; % 1
XDim = 1;
...
Connectivity( :, :,1) = xlsread('4.7897978WiNoCTest_16WI.csv');
...
LinkData(:,:,1) = xlsread('256core_Link_Distance.xls');
...
Connectivity( :, :,1) = xlsread('256wired.xls');
Connectivity( :, :,2) = xlsread('256core_Link_Distance.xls');
Connectivity( :, :,3) = Connectivity( :, :,2)';
...
LinkCycleMatrix=xlsread('256core_Link_Distance.xls');
